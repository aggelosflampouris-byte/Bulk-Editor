...
class VfxPreset(Enum):
    ...
    SUBTLE = (
        "eq=contrast=1.10:saturation=1.30,"
    ...
    VIBRANCE = (
        "eq=contrast=1.20:saturation=1.60:brightness=0.03,"
        "curves=preset=strong_contrast,"
        "unsharp=luma_msize_x=3:luma_msize_y=3:luma_amount=0.7,"
        "vignette=PI/4"
    )
    ...
    WARMTH = (
        ...
        "colorbalance=rs=0.08:gs=0.03:bs=-0.12:rm=0.05:gm=0.00:bm=-0.08,"
        "curves=preset=strong_contrast,"
        "unsharp=luma_msize_x=3:luma_msize_y=3:luma_amount=0.6"
    )
    ...
    CINEMATIC = (
        "eq=contrast=1.25:saturation=1.00,"
        "colorbalance=rs=-0.10:gs=0.00:bs=0.15,"
        "curves=preset=strong_contrast,"
    ...
    DRAMATIC = (
        "eq=contrast=1.30:saturation=0.60:gamma=0.90,"
        "curves=preset=strong_contrast,"
